...
class TraitConnectionRepositoryTest extends WebTestCase
{
    ...
    {        
        ...
        $this->assertTrue($response == 'http://temp.wrapper.grinfo.net/TIP/Wrapper.test.php?:WS:OPERATION=WS:OP:GetFeatured&:WS:FORMAT=:JSON&:WS:DATABASE=%22TEST-PGRSECURE%22&:WS:DATABASE-BIS=%22TEST-ONTOLOGY%22&:WS:CONTAINER=%22%3A_units%22&:WS:QUERY=%7B%22GRGENUS%22%3A%7B%2288%22%3A%22Oryza%22%7D%2C%220%22%3A%7B%22_query-subject%22%3A%226%22%2C%22_query-operator%22%3A%22%24EQ%22%2C%22_query-data-type%22%3A%22%3ASTRING%22%2C%22_query-data%22%3A%22%3ADOMAIN-ACCESSION%22%7D%7D&:WS:LOG-REQUEST=1&:WS:PAGE-START=0&:WS:PAGE-LIMIT=10' );
    }
}