...
class Tags{
  ...
  const kTAG_EDGES= '39';
  const kTAG_TAGS= '40';
  const kTAG_FEATURES= '41';
  const kTAG_METHODS= '42';
  const kTAG_SCALES= '43';
  const kTAG_USER_NAME= '44';
  const kTAG_USER_CODE= '45';
  const kTAG_USER_PASS= '46';
  const kTAG_USER_MAIL= '47';
  const kTAG_USER_ROLE= '48';
  const kTAG_USER_PROFILE= '49';
  const kTAG_USER_MANAGER= '50';
  const kTAG_USER_DOMAIN= '51';
  const kTAG_USER_INSTITUTE_CODE= '52';
  const kTAG_USER_INSTITUTE_NAME= '53';
  const kTAG_USER_INSTITUTE_ADDRESS= '54';
  const kTAG_USER_INSTITUTE_COUNTRY= '55';
  const kTAG_USER_SOCIAL_NETWORK= '56';
}