...
class Tags
{
  ...
  const kTAG_TAXON='1653';
  const kTAG_LOCATION='1648';
  const kTAG_ENVIRONMENT='1649';
  const kTAG_BIOCLIMATIC='1650';
  const kTAG_TEMPERATURE='1651';
  const kTAG_PRECIPITATION='1652';
  const kTAG_GENUS='1654';
  const kTAG_SPECIES='1655';
  const kTAG_INFRASPECIES='1656';
  const kTAG_TAXON_RANK='1657';
  const kTAG_TAXON_NAME='1658';
