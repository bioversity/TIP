...
class Types{
    ...
    */
     ...
     * User reference.
     *
     * This type represents the reference to a user object, user identifiers are by definition
     * strings, {@link kTYPE_STRING}.
     *
     * Version 1: (kTYPE_REF_USER)[:REF-USER]
     */
    const kTYPE_REF_USER= ':REF-USER';
     ...
     * language code in which the string, stored in the element {@link kTAG_CUSTOM_DATA}, is
     * expressed in.
     *
     ...
     * languages, it is implemented as an array of elements in which the index represents the
     * language code in which the text, stored in the element {@link kTAG_CUSTOM_DATA}, is
     * expressed in.
     *
     ...
     *
     * <ul>
     *	<li><tt>l</tt>: Minimum value.
     *	<li><tt>m</tt>: Mean value.
     *	<li><tt>h</tt>: Maximum value.
     * </ul>
     *
     * This type can be used in the following ways:
     *
     * <ul>
     *	<li><tt>m</tt> value only: In this case the attribute holds only the mean or exact value
     *		of the measurement.
     *	<li><tt>l</tt> and <tt>h</tt> value only: In this case the attribute represents the
     *		minimum and maximum values.
     *	<li><tt>l</tt>, <tt>m</tt> and <tt>h</tt>: In this case the attribute represents the
     *		minimum and maximum values, including the mean value.
     * </ul>
     *
